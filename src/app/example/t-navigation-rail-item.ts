...
@customElement('t-navigation-rail-list-item')
export class TNavigationRailListItem extends TListItem {
  static styles = [
    css`
      :host{
  ...
  @property({ type: String, attribute: 'event-name' }) event = "rail-list";
}
